...
public class CustomerUpdatedViewUseCase implements IUseCaseAccept<CustomerDTO, Void> {

    private final CustomerRepository customerRepository;

    public CustomerUpdatedViewUseCase(CustomerRepository customerRepository) {
